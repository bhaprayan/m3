CXX=g++ -std=c++11
CFLAGS=-I. /usr/lib/gcc/x86_64-redhat-linux/4.8.2/include/ -pg
OMP=-fopenmp -DOMP
...
mapgen :
	...
	$(CXX) $(OMP) -o mapgen -g -O3 -m64 -std=c++11 -w -Wno-float-equal -pedantic -lm -Isrc src/main.cc build/stb_wrapper.o
